...
const Projet = () => {
  return (
    <div id='projet' className='max-w-[1090px] mx-auto md:pl-20 p-4 py-16'>
      <h1 className='text-4xl font-bold text-center text-[#001b5e]'>Liste des projets</h1>
      <p className='text-center py-8'>Mes projets d'entraînements avant la formation</p>
